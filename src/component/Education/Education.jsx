            ...
            <div className="flex gap-8 mt-5">
                <div className="w-[64%] bg-[#f0f0f0]">
                    ...
                    <div className="p-2 space-y-2">
                        <h1 className="text-2xl hover:text-red-600 font-semibold">{education[lenN-1].news_title}</h1>
                ...
                <div className="grid gap-8 grid-cols-2 grid-rows-2">
                    <div className="bg-[#f0f0f0]">
                        ...
                        <h1 className="text-xl hover:text-red-600 font-semibold">{education[lenN-2].news_title}</h1>
                    </div>
                    <div className="bg-[#f0f0f0]">
                        <img className="w-full h-48" src={education[lenN-3].news_image} alt="" />
                        <h1 className="text-xl hover:text-red-600 font-semibold">{education[lenN-3].news_title}</h1>
                    </div>
                    <div className="bg-[#f0f0f0]">
                        <img className="w-full h-48" src={education[lenN-4].news_image} alt="" />
                        <h1 className="text-xl hover:text-red-600 font-semibold">{education[lenN-4].news_title}</h1>
                    </div>
                    <div className="bg-[#f0f0f0]">
                        <img className="w-full h-48" src={education[lenN-5].news_image} alt="" />
                        <h1 className="text-xl hover:text-red-600 font-semibold">{education[lenN-5].news_title}</h1>
                    </div>
                </div>
            </div>
                            ...
                            tempT.slice(0,visible).map((index, i) => {
                                return (
                                    <div className="flex gap-2 p-1 bg-[#f0f0f0]" key={i}>
                                       ...
                                       <h1 className="text-xl hover:text-red-600 font-semibold">{education[index].news_title}</h1>
                                    </div>
                                );
                            })
                        }
