    ...
    return (
        <div className="container mx-auto mt-16">
            ...
            <div className="flex items-center gap-3">
                <h1 className="text-3xl font-semibold mt-2 mb-2 text-green-900 ml-3">Sports</h1>
                <FaInfinity />
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 mt-6">
                <div className=" col-span-2 flex gap-2">
                    <div className="space-y-3">
                        <h1 className="text-2xl hover:text-green-800 font-semibold">{sports[len-1].news_title}</h1>
